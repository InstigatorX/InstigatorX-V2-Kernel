...
#define L_VAL_SCPLL_CAL_MAX	0x24 /* = 1512 MHz with 27MHz source */
...
static struct msm_bus_paths bw_level_tbl[] = {
	...
	[4] = BW_MBPS(2880), /* At least 360 MHz on bus. */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[25] = {1728000,  1, 0x20, 1200000, 1282500, 5},
	[26] = {1782000,  1, 0x21, 1200000, 1300000, 5},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_slow[] = {
  ...
  { {1, 1}, 1836000,  ACPU_SCPLL, 0, 0, 1, 0x22, L2(21), 1325000, 0x03006000},
  { {0, 0}, 0 },
};
